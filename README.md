...
Precision, recall, F1, and FPR measured on four synthetic fixtures (normal mean-shift, lognormal tail-shift, 5% outlier injection, 10% null injection, N=500 each). Auto-generated by `benchmarks/run_benchmarks.py`. Full results: [docs/benchmarks.md](docs/benchmarks.md) · raw CSV: [examples/benchmarks/results.csv](examples/benchmarks/results.csv).

| Detector | Precision | Recall | F1 | FPR |
|---|---|---|---|---|
| `adjusted_boxplot_fraction` | 1.00 | 0.75 | 0.86 | 0.00 |
| `auto_outlier` | 1.00 | 0.75 | 0.86 | 0.00 |
| `cusum` | 1.00 | 0.75 | 0.86 | 0.00 |
| `double_mad_outlier_fraction` | 1.00 | 0.50 | 0.67 | 0.00 |
| `generalized_esd` | 1.00 | 0.50 | 0.67 | 0.00 |
| `grubbs` | 0.67 | 0.50 | 0.57 | 0.25 |
| `holt_winters` | 1.00 | 0.75 | 0.86 | 0.00 |
| `iqr_fence` | 1.00 | 0.75 | 0.86 | 0.00 |
| `js_divergence` | 0.67 | 0.50 | 0.57 | 0.25 |
| `kl_divergence` | 1.00 | 0.50 | 0.67 | 0.00 |
| `ks_pvalue` | 1.00 | 0.50 | 0.67 | 0.00 |
| `mad_outlier_fraction` | 1.00 | 0.25 | 0.40 | 0.00 |
| `mmd` | 1.00 | 0.50 | 0.67 | 0.00 |
| `page_hinkley` | 1.00 | 0.75 | 0.86 | 0.00 |
| `psi` | 1.00 | 0.50 | 0.67 | 0.00 |
| `wasserstein_1` | 1.00 | 0.75 | 0.86 | 0.00 |
| `zscore_outlier_fraction` | 0.75 | 0.75 | 0.75 | 0.25 |
